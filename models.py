...
class GlobalParams:
    ...
    trim_mm:         int   = 10     # rebarba fixa em cada lado (nao conta como desperdicio)
    ...
    @property
    def large_usable_mm(self) -> int:
        return self.large_width_mm - 2 * self.trim_mm

    @property
    def small_usable_mm(self) -> int:
        return self.small_width_mm - 2 * self.trim_mm
